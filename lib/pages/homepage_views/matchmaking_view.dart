      ...
      children: [
        Container(
          ...
          height: MediaQuery.of(context).size.height *
              .5, // Take up the top third vertically
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: 10.0, right: 5.0), // Adjust the spacing as needed
              child: SizedBox(
            ...
            Padding(
              padding:
                  EdgeInsets.only(right: 5.0), // Adjust the spacing as needed
              child: SizedBox(
                width: 40, // Set the desired width
                height: 40, // Set the desired height
                child: Image.asset(
        ...
        Expanded(
          child: Column(
            mainAxisAlignment:
                MainAxisAlignment.end, // Align the inner column to the bottom
            children: [
